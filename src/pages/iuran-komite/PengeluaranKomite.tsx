...
export const PengeluaranKomite = () => {
  const [searchTerm, setSearchTerm] = useState("");

  // Mock data
  const pengeluaranData = [
    { id: 1, tanggal: "2024-01-15", keterangan: "Perbaikan Gedung", jumlah: 5000000, kategori: "Maintenance" },
    { id: 2, tanggal: "2024-01-10", keterangan: "Pembelian ATK", jumlah: 500000, kategori: "Operasional" },
    { id: 3, tanggal: "2024-01-05", keterangan: "Honor Guru", jumlah: 15000000, kategori: "Gaji" },
  ];
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Pengeluaran Komite</h1>
          <p className="text-muted-foreground">Kelola data pengeluaran komite</p>
        </div>
