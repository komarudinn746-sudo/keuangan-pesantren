...
export const PengeluaranSuratIzin = () => {
  const [searchTerm, setSearchTerm] = useState("");

  // Mock data
  const pengeluaranData = [
    { id: 1, tanggal: "2024-01-15", keterangan: "Biaya Administrasi", jumlah: 100000, kategori: "Admin" },
    { id: 2, tanggal: "2024-01-10", keterangan: "Materai Surat", jumlah: 50000, kategori: "ATK" },
    { id: 3, tanggal: "2024-01-05", keterangan: "Fotocopy Dokumen", jumlah: 25000, kategori: "Operasional" },
  ];
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Pengeluaran Surat Izin</h1>
          <p className="text-muted-foreground">Kelola pengeluaran terkait surat izin</p>
        </div>
