...
export const LaporanSuratIzin = () => {
  // Mock data
  const laporan = {
    totalPemasukan: 2000000,
    totalPengeluaran: 175000,
    saldoAkhir: 1825000,
    suratDiterbitkan: 45,
  };
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-foreground">Laporan Surat Izin</h1>
        <p className="text-muted-foreground">Laporan keuangan surat izin</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Surat Diterbitkan</CardTitle>
            <FileText className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{laporan.suratDiterbitkan}</div>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Analisis keuangan surat izin bulan ini</CardDescription>
        </CardHeader>
        <CardContent>
