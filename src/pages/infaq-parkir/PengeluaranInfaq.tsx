...
export const PengeluaranInfaq = () => {
  const [searchTerm, setSearchTerm] = useState("");

  // Mock data
  const pengeluaranData = [
    { id: 1, tanggal: "2024-01-15", keterangan: "Perawatan Area Parkir", jumlah: 200000, kategori: "Maintenance" },
    { id: 2, tanggal: "2024-01-10", keterangan: "Gaji Petugas Parkir", jumlah: 500000, kategori: "Gaji" },
    { id: 3, tanggal: "2024-01-05", keterangan: "Pembelian Perlengkapan", jumlah: 100000, kategori: "Operasional" },
  ];
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Pengeluaran Infaq Parkir</h1>
          <p className="text-muted-foreground">Kelola pengeluaran dana infaq parkir</p>
        </div>
